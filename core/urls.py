...
urlpatterns = [
    ...
    path('dashboard/city-admins/', views.dashboard_city_admins, name='dashboard_city_admins'),
    path('dashboard/roles-permissions/', views.dashboard_roles_permissions, name='dashboard_roles_permissions'),
    path('dashboard/modules/', views.dashboard_platform_modules, name='dashboard_platform_modules'),
    path('dashboard/settings/', views.dashboard_platform_settings, name='dashboard_platform_settings'),
    path('dashboard/audit-logs/', views.dashboard_audit_logs, name='dashboard_audit_logs'),
    path('dashboard/sub-admins/', views.dashboard_sub_admins, name='dashboard_sub_admins'),
    path('dashboard/sub-admins/<int:user_id>/permissions/', views.dashboard_sub_admin_permissions, name='dashboard_sub_admin_permissions'),
    path('dashboard/content-providers/', views.dashboard_content_providers, name='dashboard_content_providers'),
    path('dashboard/city-modules/', views.dashboard_city_modules, name='dashboard_city_modules'),
